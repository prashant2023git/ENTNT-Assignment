...
const AddJobDialog = ({ isOpen, onClose, onSave }) => {
    ...
    return (
        <div className="fixed inset-0 bg-[#1f2937]/80 flex justify-center items-center p-4 z-50">
            <div className="hide-scrollbar bg-[#1f2937] border border-[#1f2937] rounded-xl shadow-2xl p-8 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                <div className="flex justify-between items-center border-b border-blue-800 pb-4 mb-6">
                    <h2 className="text-2xl font-bold text-blue-50">Add New Job</h2>
